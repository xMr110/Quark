            ...
            success: function (data) {
                ...
                if (data.status) {
                    if (data.type == 'active') {
                        ...
                        $(this).find('i').removeClass('mdi-bell').addClass('mdi-bell-off');
                        message = 'It is an Offer Now!';
                    }
                    ...
                    if (data.type == 'active') {
                        ...
                        $(this).find('i').removeClass('mdi-bell-off').addClass('mdi-bell');
                        message = 'It is normal Package Now!';
                    }
                }
