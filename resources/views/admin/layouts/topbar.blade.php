...
<header class="topbar">
    ...
    <div class="navbar-header">
        ...
        <!-- Logo text --><span>
                         <!-- dark Logo text -->
            <!-- Light Logo text -->
                         <img width="120px" style="margin-top: 10px!important;" height="35px" src="/assets/backend/images/logo-light-text.png" class="light-logo"
                              alt="homepage"/>
                </span> </a>
        </div>
        <!-- ============================================================== -->
    ...
    <ul class="navbar-nav my-lg-0">
                ...
                <ul>
                    <li>
                        {{--@if($newnotes = count(Auth::user()->unreadNotifications))--}}
                            {{--<div class="drop-title">You Have New Notification {{$newnotes}}--}}

                                {{--<br>--}}
                                {{--<a class="text-danger" markAllRead href="#"><small>Mare All As Readed</small></a>--}}
                            {{--</div>--}}
                        {{--@else--}}
                            {{--<div class="drop-title">There is No New Notification</div>--}}
                        ...
                        <div class="message-center" id="showNotification2">
                            {{--@foreach(Auth::user()->notifications as $note)--}}
                                {{--<div class="row" id="MakeRead">--}}
                                    {{--<div class="col-sm-12">--}}
                                        {{--<a href="{{$note->data['link']}}"  data-noteid="{{ $note->id }}"  notification class="{{ $note->read_at == null ? 'unread' : ''}}"--}}
                                         {{-->--}}
                    ...
                    <li>
                        {{--<a class="nav-link text-center" href="{{ action('Admin\NotificationController@index') }}"> <strong>All Notification</strong> <i class="fa fa-angle-left"></i> </a>--}}
                    </li>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false"><img src="/assets/backend/images/users/img/man.png" alt="user"
                                                               class="profile-pic"/></a>
            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                <ul class="dropdown-user">
                    <li>
                        <div class="dw-user-box">
                            <div class="u-img"><img src="/assets/backend/images/users/img/man.png" alt="user"></div>
                            <div class="u-text">
